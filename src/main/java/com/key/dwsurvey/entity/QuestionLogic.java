...
public class QuestionLogic extends IdEntity{
	...
	private String eqAndNq ;
	
	
	
	public String getEqAndNq() {
		return eqAndNq;
	}
	public void setEqAndNq(String eqAndNq) {
		this.eqAndNq = eqAndNq;
	}

	//移除题的选项字段
	private String ckQuItemId;
	
	public String getCkQuItemId() {
		return ckQuItemId;
	}
	public void setCkQuItemId(String ckQuItemId) {
		this.ckQuItemId = ckQuItemId;
	}
