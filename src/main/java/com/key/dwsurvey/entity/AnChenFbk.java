...
public class AnChenFbk extends IdEntity {
		...
		public String toString() {
			return "AnChenFbk [belongId=" + belongId + ", belongAnswerId="
					+ belongAnswerId + ", quId=" + quId + ", quRowId="
					+ quRowId + ", quColId=" + quColId + ", answerValue="
					+ answerValue + ", visibility=" + visibility + ", anCount="
					+ anCount + "]";
		}
		public AnChenFbk(){
