...
public class Question extends IdEntity{
	...
	//是否是分项题
	private String isSubentry;
	
	//判断是否是滑块题的字段
	private  String isSlider;
	
	private String isScoreInput;
	
	public String getIsScoreInput() {
		return isScoreInput;
	}
	public void setIsScoreInput(String isScoreInput) {
		this.isScoreInput = isScoreInput;
	}


	//表格长度回显
	private String  trWidthInfo;
	...
	public String getTrWidthInfo() {
		return trWidthInfo;
	}
	public void setTrWidthInfo(String trWidthInfo) {
		this.trWidthInfo = trWidthInfo;
	}


	private Integer minSliderLength;
	
	private Integer maxSliderLength;
	
	private Integer totalSliderLength;
	
	public Integer getMinSliderLength() {
		return minSliderLength;
	}
	public void setMinSliderLength(Integer minSliderLength) {
		this.minSliderLength = minSliderLength;
	}
	public Integer getMaxSliderLength() {
		return maxSliderLength;
	}
	public void setMaxSliderLength(Integer maxSliderLength) {
		this.maxSliderLength = maxSliderLength;
	}
	public Integer getTotalSliderLength() {
		return totalSliderLength;
	}
	public void setTotalSliderLength(Integer totalSliderLength) {
		this.totalSliderLength = totalSliderLength;
	}
	public String getIsSubentry() {
		return isSubentry;
	}
	...
	public void setIsSubentry(String isSubentry) {
