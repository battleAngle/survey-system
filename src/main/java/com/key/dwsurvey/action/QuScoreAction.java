...
public class QuScoreAction extends ActionSupport{
	...
	private Question ajaxBuildSaveOption(HttpServletRequest request) throws UnsupportedEncodingException {
		...
		String isScoreInput=request.getParameter("isScoreInput");
		Integer minSliderLength=Integer.parseInt(request.getParameter("minSliderLength"));
		Integer maxSliderLength=Integer.parseInt(request.getParameter("maxSliderLength"));
		Integer totalSliderLength=Integer.parseInt(request.getParameter("totalSliderLength"));
		...
		entity.setIsScoreInput(isScoreInput);
		entity.setIsSlider(isSlider);
		entity.setMinSliderLength(minSliderLength);
		entity.setMaxSliderLength(maxSliderLength);
		entity.setTotalSliderLength(totalSliderLength);
		...
		if(paramInt02!= null && !paramInt02.equals("") && !paramInt02.equals("undefined")){
