...
public class JspToHtml {
	...
	public void postJspToHtml(String postUrl, String filePath,String fileName) throws Exception{
		...
		String reqTarget = request.getScheme()+"://"+ip+(request.getServerPort()==80?"":":"+request.getServerPort())+request.getContextPath();
		reqTarget =reqTarget+"/toHtml";
		
		System.err.println(reqTarget);
		...
		connection.data(map);
		Document doc=connection.timeout(32000).get();
	}
