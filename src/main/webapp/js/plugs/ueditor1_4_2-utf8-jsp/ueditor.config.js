...
(function () {
   ...
   var URL = window.UEDITOR_HOME_URL || getUEBasePath();
    ...
    window.UEDITOR_CONFIG = {
    	...
    	/*,toolbars:[
               ['Bold','Underline','StrikeThrough','removeformat','|','InsertUnorderedList','InsertOrderedList','|','Link','Unlink','|','simpleupload', 'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map','|','Source','FullScreen','forecolor']
         ]*/
