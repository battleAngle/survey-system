				...
				$.ajax({
					...
					success:function(msg){
						...
						if(survey.surveyDetail.endTime!="null"){
							...
							console.log(survey.surveyDetail.endTime );
							if(survey.surveyDetail.endTime != null && survey.surveyDetail.endTime != ""){
								$("#myDialogRoot input[name='endTime']").val(datetimeFormat(survey.surveyDetail.endTime.time));
							}else{
			...
			success:function(msg){
				if(msg==="true"){
					if(thText==="开始收集"){
					    ...
					    // $(".collectInfoSpan").text("收集中");
					}else if(thText==="停止收集"){
						thBtn.text("重新打开收集");
						$(".surveyStateText").text("收集完成");
						// $(".collectInfoSpan").text("收集完成");
					}else if(thText==="重新打开收集"){
						thBtn.text("停止收集");
						$(".surveyStateText").text("收集中");
					  //	 $(".collectInfoSpan").text("收集中");
