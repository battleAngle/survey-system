											...
											<c:when test="${page.totalItems > 0}">
												...
												<c:forEach items="${page.result }" var="en">
													<tr>
														...
														<td align="center">${en.loginName }</td>
														...
														<td align="center">
															...
															<a class="btn btn-default disUser_a" href="${ctx }/sy/user/nosm/user-admin!delete.action?id=${en.id}" title="删除"data-toggle="tooltip" data-placement="top" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
														</td>
													</tr>
												</c:forEach>
...
function  jumpPage(pageNo){
    ...
    window.location.href="${ctx }/sy/user/user-admin.action?page.pageNo="+pageNo+"&status="+status+"&loginName="+loginName;
}
