			...
			<div class="surveyCollectMiddle">
				...
				<div class="surveyCollectTop">
					...
					<div class="surveyCollectInfoDiv">
						...
						参加人数：<span class="collectInfoSpan surveyStateUserNum">${survey.answerNum eq null ? 0 : survey.answerNum }</span>
						</span>
							...
							<div style="padding-top: 5px;">
								<table class="emailInboxList contacts-table" width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<th style="text-align: center;">回答用户</th>
...
$(".deleteSurveyAnswer").click(function(){
	...
	var surveyStateUserNumText=$(".surveyStateUserNum").text();
	if(confirm("确定删除答卷数据？")){
		...
		$.ajax({
			...
			success:function(msg){
				if(msg==="true"){
					thTr.remove();
					$(".surveyStateUserNum").text(surveyStateUserNumText - 1);
				}else{
					alert("抱歉，删除失败！");
				}
			}
