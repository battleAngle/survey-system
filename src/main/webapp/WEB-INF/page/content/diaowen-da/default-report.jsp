				...
				<div class="surveyCollectTop">
					<div class="surveyCollectTitleDiv">
						...
						<div class="scmTabRight" >
						     <%-- <c:if test="${directory.surveyState eq 1 }">
						     <a href="" class="sbtn25 sbtn25_2  surveyStateBtn" style="display:none" >停止收集</a>
						     </c:if>
						      <c:if test="${directory.surveyState eq 2 }">
						     <a href="" class="sbtn25 sbtn25_2  surveyStateBtn">重新打开收集</a>
						     </c:if> --%>
					...
					<div class="surveyCollectInfoDiv">
						...
						参与人数：<span class="collectInfoSpan">${directory.answerNum eq null ? 0 : directory.answerNum }</span>
						</span>
								...
								<c:choose>
										...
										<c:when test="${en.quType eq 'RADIO' }">
											...
											<c:forEach items="${en.quRadios }" var="quEn" varStatus="quI">
														<tr class="quTrOptions">
															...
															<td width="70px" align="right" id="bfbNum${en.quType }${i.count }_${quI.count}" class="bfbTd">0%</td>
											...
											<table class="suQuTable" border="0" cellpadding="0" cellspacing="0">
												<c:forEach items="${en.quMultiFillblanks }" var="quEn" varStatus="quI">
													<tr class="quTrOptions">
														<td width="15px">&nbsp;</td>
														<td width="520px">${quEn.optionName }</td>
														<td class="bfbTd">回答数：${quEn.anCount }条&nbsp;&nbsp;<a href="${ctx}/design/qu-multi-fillblank!answers.action?quId=${en.id}&surveyId=${surveyId}&quMultBankId=${quEn.id}">查看</a></td></td>
														<td colspan="4"></td>
													</tr>
												</c:forEach>
												</table>
										...
										<c:when test="${en.quType eq 'CHENRADIO' }">
													<table class="suQuTable" border="0" cellpadding="0" cellspacing="0">
														...
														<tr class="rowItemTr">
															...
															<td class="quChenRowTd" colspan="5"><label class="editAble quCoOptionEdit" style="font-size: 14px;">${rowItem.optionName }</label></td>
														</tr>
														...
														<tr class="columnItemTr">
															...
															<td width="70px" align="right" id="bfbNum${en.quType }${i.count }_${rowI.count}_${colI.count}" class="bfbTd">0%</td>
										...
										<c:when test="${en.quType eq 'CHENFBK' }">
												<table class="suQuTable" border="0" cellpadding="0" cellspacing="0" >
													...
													<tr class="rowItemTr">
														<td width="15px">&nbsp;</td>
														<td class="quChenRowTd" colspan="4"><label class="editAble quCoOptionEdit" style="font-size: 14px;">${rowItem.optionName }</label></td>
													</tr>
													<c:forEach items="${en.columns }" var="columnItem" varStatus="colI">
													<tr class="columnItemTr">
														<td width="15px">&nbsp;</td>
														...
														<c:forEach items="${en.anChenFbks }" var="anItem">
															<c:if test="${anItem.quRowId eq rowItem.id && anItem.quColId eq columnItem.id }">
																<script type="text/javascript">
																	...
																	$("#bfbAnCount${en.quType }${i.count }_${rowI.count}_${colI.count}").html("&nbsp;&nbsp;<a href=\"${ctx}/design/qu-chen!answers.action?quId=${en.id}&surveyId=${surveyId}&quRowId=${anItem.quRowId}&quColId=${anItem.quColId}\">查看</a>");
																</script>
															</c:if>
														</c:forEach>
														</td>
										...
										<c:when test="${en.quType eq 'COMPCHENRADIO' }">
											<table class="suQuTable" border="0" cellpadding="0" cellspacing="0">
												<tr>
														<td width="15px">&nbsp;</td>
														<td class="bfbTd" width="70px">回答数：${en.anCount }</td>
														<td colspan="4"></td>
													</tr>
											</table>
										<div class="reportPic"></div>
											...
											<table class="suQuTable" border="0" cellpadding="0" cellspacing="0">
												<c:forEach items="${en.quOrderbys }" var="quEn" varStatus="quI">
														<tr  class="quTrOptions" >
															<td width="15px">&nbsp;</td>
															<td width="520px" class="optionName" >${quEn.optionName }</td>
															<%-- <td width="180px"><div id="bfbTd${en.quType }${i.count }_${quI.count}" class="progressbarDiv progress${quI.index }">${quEn.anOrderSum }</div></td>
