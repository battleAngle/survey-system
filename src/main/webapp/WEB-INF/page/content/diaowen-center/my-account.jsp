...
$(document).ready(function(){
	...
	//手机号码规则验证
	jQuery.validator.addMethod("isMobile", function(value, element) {   var length = value.length;   var mobile = /^(13[0-9]{9})|(18[0-9]{9})|(14[0-9]{9})|(17[0-9]{9})|(15[0-9]{9})$/;   return this.optional(element) || (length == 11 && mobile.test(value));  }, "请正确填写手机号码");  

	
	var inputFormValidate=$("#input_form").validate({
		rules: {
			email: {required: true, email: true, maxlength: 60},
			cellphone:{required : true,isMobile : true},
