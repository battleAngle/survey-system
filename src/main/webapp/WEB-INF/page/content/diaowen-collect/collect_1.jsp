						...
						<div style="" >
							...
							<div>
								<div class="scmcSurveyLink">
									...
									${baseUrl }/wenjuan/${survey.sid }.html?sdate=${now.time}
									</span>
									<span class="scmcSurveyLinkRight"><span id="clipLinkSpan" style="display: none;">复制成功</span></span>
									<a href="#" style="display: block;" class="clipLink" id="clipLink" data-clipboard-text="${baseUrl }/wenjuan/${survey.sid }.html?sdate=${now.time}">复制链接</a>
