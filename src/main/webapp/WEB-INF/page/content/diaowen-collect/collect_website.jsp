				...
				<div class="surveyCollectTop">
					...
					<div class="surveyCollectInfoDiv">
						...
						状态：
						 <c:choose>
								<c:when test="${survey.surveyState eq 0 }">
									<span class="collectInfoSpan surveyStateText">设计中</span>&nbsp;&nbsp;&nbsp;&nbsp;
								</c:when>
								<c:when test="${survey.surveyState eq 1 }">
									<span class="collectInfoSpan surveyStateText">收集中</span>&nbsp;&nbsp;&nbsp;&nbsp;
								</c:when>
								<c:when test="${survey.surveyState eq 2 }">
									<span class="collectInfoSpan surveyStateText">收集完成</span>&nbsp;&nbsp;&nbsp;&nbsp;
								</c:when>
							</c:choose>
						<%-- <span class="collectInfoSpan surveyStateText">${survey.surveyState eq 0 ? '设计中':survey.surveyState eq 1?'收集中':survey.surveyState eq 2?'收集完成':'' }</span>&nbsp;&nbsp;&nbsp;&nbsp; --%>
